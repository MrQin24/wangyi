                ...
                <div>
                    ...
                    <div style={{ backgroundColor: 'white', display: 'flex', justifyContent: "space-between", alignItems: "center", textAlign: 'center', padding: '1rem', }}>
                        <div style={{ display: 'flex', justifyContent: "space-around", alignItems: "center" }}>
                            <img src='./b/a3d.png' style={{ width: '1.9rem', verticalAlign: 'bottom' }} alt='' />
                            <div style={{ fontSize: '1.4rem', paddingLeft: '1rem' }}>播放全部</div>
                            <div style={{ fontSize: '1rem', color: 'gray' }}>(共{this.state.length}首)</div>
                        </div>
                        <div style={{ display: 'flex', justifyContent: "space-around", alignItems: "center" }}>
                            <img src='./b/q2.png' style={{ width: '1.9rem', verticalAlign: 'bottom' }} alt='' />
                            <div>多选</div>
                        </div>
                    </div>
                </div>
