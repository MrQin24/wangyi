  ...
  progerss() {
    ...
    componentDidMount() {
        setTimeout(() => {
            ...
            // this.state.newMusic = this.props.nextmusic;
            // this.props.dispatch(getNewMusic(this.state.newMusic))
            // console.log(this.props.nextmusic._id)
            // this.props.dispatch(getNewSong(this.props.nextmusic._id))

            // if(this.props.songer){}
            console.log('我是新的音乐', this.state.newMusic)
            console.log('我是状态机里的音乐', this.props.getnewmusic)
            bgBegin();
            setBegin();
            play.src = './b/act.png';
        }, 200)
